...
const TRPC_API_DIST = {
  owner: "chlomacg",
  repository: "annotations-anonymous-server",
  filePaths: [
    {
      sourcePath: "trpc-api-export/dist/index.d.mts",
      targetPath: "src/common/trpc-api-boilerplate/api-types/index.d.mts",
    },
    {
      sourcePath: "trpc-api-export/dist/index.mjs",
      targetPath: "src/common/trpc-api-boilerplate/api-types/index.mjs",
    },
  ],
